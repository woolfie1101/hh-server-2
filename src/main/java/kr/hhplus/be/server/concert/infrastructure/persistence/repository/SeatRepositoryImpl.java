...
import kr.hhplus.be.server.concert.infrastructure.persistence.jpa.SeatJpaRepository;
...
public class SeatRepositoryImpl implements SeatRepository {
    ...
    public boolean existsByConcertIdAndSeatNumber(UUID concertId, String seatNumber) {
        return seatJpaRepository.existsByConcertIdAndSeatNumber(concertId, seatNumber);
    }

    @Override
    public boolean existsBySeatIdAndStatus(UUID seatId, ReservationStatus status) {
        return seatJpaRepository.existsBySeatIdAndStatus(seatId, status);
    }
